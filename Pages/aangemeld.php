<?php
	...
	if(isset($_GET["verzend"]))
	{
        ...
        mysqli_query($mysql,"INSERT INTO leden(voornaam,naam,adres,woonplaats,telefoonnr,geslacht,geboortedatum,inschrijfdatum,enkel,dubbel) VALUES('$voornaam','$dbachternaam','$adres','$woonplaats','$telefoonnr','$geslacht', '$geboortedatum', '$inschrijfdatum', '$enkel','$dubbel')
        ") or die("De insertquery op de database is mislukt!");
        $toegevoegd = mysqli_query($mysql,"SELECT * FROM `leden` WHERE voornaam = '$voornaam' and naam = '$dbachternaam' and adres = '$adres' and woonplaats = '$woonplaats' and geslacht = '$geslacht' and enkel = '$enkel' and dubbel = '$dubbel' and geboortedatum = '$geboortedatum' and inschrijfdatum = '$inschrijfdatum' and telefoonnr = '$telefoonnr'") or die("De selectquery op de database is mislukt!");
			...
			<div id="mk-theme-container" >
				<header data-height='160'
					...
					<section id="mk-page-introduce" class="intro-left">
						<div class="mk-grid">
							<h1 class="page-title" style=text-align:center>Inschrijfformulier</h1>
							<div id="mk-breadcrumbs">
								<div class="mk-breadcrumbs-inner"><span xmlns:v="http://rdf.data-vocabulary.org/#"><span typeof="v:Breadcrumb"><a href="https://v21dkoeve.helenparkhurst.net/Informatica/.Tennis%20PO/index.php" rel="v:url" property="v:title">Home</a> &#47; <span rel="v:child" typeof="v:Breadcrumb">Inschrijfformulier</span></span></span></div>
							</div>
							<div class="clearboth"></div>
						</div>
					</section>
				...
				<div id="pag1" data-role="page" data-theme="b">
					<div data-role="header">
						<h1 style="margin-left:20.2%">Aanmelden</h1>
					</div>
					<div role="main" class="ui-content">
						<form action="aangemeld.php" method="get" style="font-size:20px">
							<label for="voornaam" style="margin-left:20%;padding-right:50%">Voornaam:<label style=color:red>*</label></label>
                            <br>
                            ...
                            <br><br>
                            <label for="achternaam" style="margin-left:20%;padding-right:50%">Achternaam:<label style=color:red>*</label></label>
                            <br>
							<input name="achternaam" id="achternaam" type="text" placeholder="Achternaam" value="" data-mini="true" style=";margin-left:20%;width: 56.2%" required>
                            <br><br>
                            <label for="geboortejaar" style="margin-left:20%;padding-right:50%">Geboortedatum:<label style=color:red>*</label></label>
							<br>
							<input name="geboortejaar" id="geboortejaar" type="date" value="" data-highlight="true" data-mini="true" style="margin-left:20%;width: 56.2%;border:0;" required>
                            <br><br>
							<label for="adres" style="margin-left:20%;padding-right:50%">Adres:<label style=color:red>*</label></label>
							<br>
							<input name="adres" id="adres" type="text" placeholder="Adres" value="" data-mini="true" style="margin-left:20%;width: 56.2%" required>
                            <br><br>
							<label for="woonplaats" style="margin-left:20%;padding-right:50%">Woonplaats:<label style=color:red>*</label></label>
							<br>
							<input name="woonplaats" id="woonplaats" type="text" placeholder="Woonplaats" value="" data-mini="true" style="margin-left:20%;width: 56.2%" required>
                            <br><br>
                            <label for="telefoonnr" style="margin-left:20%;padding-right:50%">Telefoonnr:<label style=color:red>*</label></label>
							<br>
							<input type="number" id="telefoonnr" name="telefoonnr" style="margin-left:20%;width: 56%" required>
							<div data-type="horizontal" data-mini="true" style="margin-left:20%;width: 56%">
								<label for="geslacht">Selecteer uw Geslacht:<label style=color:red>*</label></label>
								<br>
								<select name="geslacht" id="geslacht" data-native-menu="false" data-mini="true" required>
							...
							<div data-type="horizontal" data-mini="true" style="margin-left:20%;width: 56%">
								<label for="enkel">Selecteer uw Enkel:<label style=color:red>*</label></label>
								<br>
								<select name="enkel" id="enkel" data-native-menu="false" data-mini="true" required>
							...
							<div style="margin-left:20%;width: 56%" data-type="horizontal" data-mini="true">
								<label for="dubbel">Selecteer uw Dubbel:<label style=color:red>*</label></label>
								<br>
								<select name="dubbel" id="dubbel" data-native-menu="false" data-mini="true" required>
									<option value="A1">A1</option>
									<option value="A2">A2</option>
									<option value="A3">A3</option>
									<option value="B1">B1</option>
							...
							<button class="ui-shadow ui-btn ui-corner-all ui-mini" id="verzend" type="submit" name="verzend" style="margin-left:20%;width: 56.2%">Verzend</button>
						</form>
						<div class="ui-body ui-corner-all" style="margin-left:19.5%;width:56%;font-size:20px;">
							<?php
								...
								if(isset($_GET["verzend"]))
								{
                                    ...
                                    $de = date('d/m/Y', strtotime($_GET['geboortejaar']));
									...
									echo"<br><strong style=font-size:27px;>U heeft zich succevol opgegeven. Dit zijn de door u ingevulde gegevens:<br><br></strong>";
									while(list($lidnr, $voornaam, $dbachternaam, $adres, $woonplaats, $telefoonnr, $geslacht, $geboortedatum, $inschrijfdatum, $enkel, $dubbel) = mysqli_fetch_row($toegevoegd))
									{
										echo"<strong>Lidnr:</strong> $lidnr <br><strong>Voornaam:</strong> $voornaam <br> <strong>Tussenvoegsel:</strong> $tussenvoegsel <br> <strong>Achternaam:</strong> $achternaam <br> <strong>Geboortejaar:</strong> $de<br> 
                                        <strong>Leeftijd:</strong> $age jaar<br><strong>Adres:</strong> $adres <br><strong>Woonplaats:</strong> $woonplaats<br>
                                        <strong>Telefoonnummer:</strong> $telefoonnr<br><strong>Geslacht:</strong> $geslacht<br> <strong>Enkel:</strong> $enkel<br> <strong>Dubbel:</strong> $dubbel
                                        <br><br><strong>De door u te betalen contributie (per seizoen):</strong> €$contributie<br>";
										echo"▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬<br>";
									}
								}
