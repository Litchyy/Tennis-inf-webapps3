<?php
	...
	if(isset($_GET["verzend"]))
	{
	       ...
	       $boetenr = mysqli_real_escape_string($mysql,$_GET["boetenr"]);
	...
	<body>
		...
		<header data-height='160'
					...
					<div class="mk-responsive-wrap">
						<nav class="menu-main-menu-container">
							<ul id="menu-main-menu-1" class="mk-responsive-nav">
								...
								<li id="responsive-menu-item-8258" class="menu-item menu-item-type-post_type menu-item-object-page"><a class="menu-item-link js-smooth-scroll"  href="https://v21dkoeve.helenparkhurst.net/Informatica/.Tennis%20PO/Pages/leden.php">Leden</a></li>
			...
			<section id="mk-page-introduce" class="intro-left">
				<div class="mk-grid">
					<h1 class="page-title" style=text-align:center>Boetes</h1>
					<div id="mk-breadcrumbs">
						<div class="mk-breadcrumbs-inner"><span xmlns:v="http://rdf.data-vocabulary.org/#"><span typeof="v:Breadcrumb"><a href="https://v21dkoeve.helenparkhurst.net/Informatica/.Tennis%20PO/index.php" rel="v:url" property="v:title">Home</a> &#47; <span rel="v:child" typeof="v:Breadcrumb">Boetes</span></span></span></div>
					</div>
					<div class="clearboth"></div>
				</div>
			</section>
		...
		<div data-role="header">
			<h1 style="margin-left:20%">Boetes zoeken</h1>
		</div>
		<div role="main" class="ui-content">
			<div role="main" class="ui-content">
				<form action="boetes.php" method="get" style="font-size:20px">
					<label for="boetenr" style="margin-left:20%;padding-right:50%">Boetenr:</label>
					<br>
					<input name="boetenr" id="boetenr" type="text" placeholder="boetenr" value="" data-mini="true" style="margin-left:20%;width: 56%">
					<br><br>
					<label for="lidnr" style="margin-left:20%;padding-right:50%">Lidnr:</label>
					<br>
					<input name="lidnr" id="lidnr" type="text" placeholder="lidnr" value="" data-mini="true" style="margin-left:20%;width: 56%">
					<br><br>
					<label for="jaar" style="margin-left:20%;padding-right:50%">Datum:</label>
					<br>
					<input name="jaar" id="jaar" type="date" value="" data-highlight="true" data-mini="true" style="margin-left:20%;width: 56%;border:0;">
					<br><br>
                    ...
                    <br>
					<button class="ui-shadow ui-btn ui-corner-all ui-mini" id="verzend" type="submit" name="verzend" style="margin-left:20%;width: 56%">Zoek!</button>
					<br><br>
				</form>
