			...
			<div id="mk-theme-container" >
				<header data-height='160'
					...
					<section id="mk-page-introduce" class="intro-left">
						<div class="mk-grid">
							<h1 class="page-title" style=text-align:center>Home</h1>
				...
				<div class="homebody" align=center>
					...
					<?php
						...
						$leden = mysqli_query($mysql,"SELECT MAX(lidnr) FROM leden") or die("De selectquery op de database is mislukt!");
					...
					<p style="text-align: center">
						Betaling kan via automatische incasso.  Dit kunt u aangeven op de betaal-pagina in de mail die u ontvangt van Club Collect.  Hier kunt u uw keuze; betaling in vier termijnen of betaling ineens, aangeven.
					</p>
					<br>
					<h3 style="text-align: center">
						OPZEGGEN
